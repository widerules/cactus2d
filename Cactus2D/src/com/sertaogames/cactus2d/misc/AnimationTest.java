...
public class AnimationTest extends GdxTest {
	...
	@Override
	public void create() {
		Texture texture = new Texture(Gdx.files.internal("data/textures/sprites-color-novo.png"));
		TextureRegion[] leftWalkFrames = TextureRegion.split(texture, 86, 78)[1];
		...
		leftWalk = new Animation(0.05f, leftWalkFrames);
		rightWalk = new Animation(0.05f, rightWalkFrames);
	...
	public static void main(String[] args) {
		new JoglApplication(new AnimationTest(), "Box2D test", 1024, 600, false);
		// Textu
	}
}
